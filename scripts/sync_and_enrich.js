...
const RAW_PRODUCTS = [
  ...
  "PQQ комплекс капс. (энергия, продуктивность) 20мг №30 GLS",
  "Алоэ Вера капс. (красота, иммунитет) 200мг №60 GLS",
  ...
  "Глутатион капс. (омоложение, очищение) 150мг №60 GLS",
  "Глюкозамин Хондроитин капс. (суставы, кости) 400мг №120 GLS",
  "Диабет формула капс.450мг №60 GLS",
  "Железо фумарат капс. (кислород, энергия, гемоглобин) 270мг №90 GLS",
  ...
  "Йохимбе капс (похудение, энергия) 30мг №60 GLS",
  ...
  "Коллаген для суставов с Мартинией капс. №120 GLS",
  ...
  "Л-карнитин капс. (похудение, мышцы) 400мг №90 GLS",
